...
<head>
    ...
    <style>
        ...
        ::-webkit-scrollbar-thumb:hover { background: linear-gradient(180deg, #db2777, #06b6d4); }
    ...
    {{-- Navigation --}}
        ...
        <div x-show="mobileMenuOpen" 
            ...
            <div class="px-4 pt-2 pb-4 space-y-2">
                <a href="{{ route('home') }}" class="block px-4 py-2 text-gray-700 hover:bg-pink-50 hover:text-pink-600 rounded-lg transition">Home</a>
                <a href="{{ route('features') }}" class="block px-4 py-2 text-gray-700 hover:bg-pink-50 hover:text-pink-600 rounded-lg transition">Features</a>
                <a href="{{ route('pricing') }}" class="block px-4 py-2 text-gray-700 hover:bg-pink-50 hover:text-pink-600 rounded-lg transition">Pricing</a>
                <a href="{{ route('about') }}" class="block px-4 py-2 text-gray-700 hover:bg-pink-50 hover:text-pink-600 rounded-lg transition">About</a>
                <a href="{{ route('contact') }}" class="block px-4 py-2 text-gray-700 hover:bg-pink-50 hover:text-pink-600 rounded-lg transition">Contact</a>
                
                @auth
                    <a href="{{ route('dashboard') }}" class="block px-4 py-2 text-gray-700 hover:bg-pink-50 hover:text-pink-600 rounded-lg transition">Dashboard</a>
                @else
                    <a href="{{ route('login') }}" class="block px-4 py-2 text-gray-700 hover:bg-pink-50 hover:text-pink-600 rounded-lg transition">Login</a>
                    <a href="{{ route('register') }}" class="block px-4 py-2 bg-gradient-to-r from-pink-600 to-pink-500 text-white text-center rounded-lg hover:shadow-lg transition">
                        Get Started
                    </a>
                @endauth
            </div>
